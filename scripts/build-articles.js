...
const BASE_CSS = `
  ...
  *{box-sizing:border-box}
  ...
  .gcard{display:grid;grid-template-columns:180px 1fr;gap:18px;padding:18px;border:1px solid var(--line);border-radius:14px;
  ...
  .gcard .cover{border-radius:10px;overflow:hidden;background:#e9eef7;height:100%;min-height:0}
  ...
  @media (max-width:640px){
    .gcard{grid-template-columns:1fr;gap:14px;padding:14px}
