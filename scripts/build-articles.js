...
// ===== 3. 全站统一版式（干净简洁） =====
const BASE_CSS = `
  :root{--ink:#eef2f7;--ink2:#c6d0e2;--muted:#9aa7ba;--line:rgba(255,255,255,.1);--brand:#5b8cff;--brand-soft:rgba(91,140,255,.14);--accent:#f5b50a;--bg:#0b101a;--card:#16202f}
  *{box-sizing:border-box}
  ...
  .dl .and{background:#3d7bff;box-shadow:0 6px 16px rgba(61,123,255,.32)}
  ...
  .gcard:hover{box-shadow:0 6px 20px rgba(0,0,0,.34)}
  ...
  .gcard:hover{border-color:rgba(91,140,255,.5);box-shadow:0 8px 24px rgba(0,0,0,.32)}
  .gcard .cover{border-radius:8px;overflow:hidden;background:#1a2537;align-self:start}
  ...
  .gcard .gcat{font-size:11.5px;color:var(--muted);font-weight:500}
  .gcard .cnt{font-size:11px;font-weight:600;color:var(--brand);background:var(--brand-soft);
    padding:2px 8px;border-radius:99px;white-space:nowrap}
  .gcard .alist{display:flex;flex-direction:column;gap:5px;margin:0;padding:0;list-style:none}
  .gcard .alist li{margin:0;padding:0}
  .gcard .alist a{display:block;font-size:13px;color:var(--ink2);padding:8px 10px;min-height:40px;border-radius:6px;
  ...
  .gcard .alist .cat.info{background:var(--accent);color:#241a00}
  ...
  .gcard .more{font-size:11.5px;color:var(--muted);margin-top:2px;align-self:flex-start;text-decoration:none;display:inline-block;padding:8px 0}
