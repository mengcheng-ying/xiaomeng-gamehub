...
.grid>.card img{flex:0 0 auto}
  ...
  .gcard .alist .cat{display:inline-block;font-size:11px;font-weight:600;color:#fff;
    background:var(--brand-deep);border-radius:4px;padding:1px 5px;margin-right:5px;vertical-align:middle}
